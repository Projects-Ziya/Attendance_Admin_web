...
import AddBranchModal from "./AddBranchModal"; // 👈 Import your modal component
...
const BranchCard = ({
  ...
  return (
    <div className="rounded-[5px] w-[345px] h-[383px] pb-[50px] bg-white shadow-metrics pl-[34px] pr-[34px] pt-[30px] flex flex-col">
      ...
      <div className="flex justify-between pt-[17px]">
        <p
          className="text-[12px] tracking-[0.08em] leading-[16px]"
          style={{ color: themeColor }}
        >
          {startDate}
        </p>
...
const AddBranchCard = () => {
  ...
  return (
    <div>
      {/* Add New Branch Card */}
      <div
        className="rounded-[5px] w-[345px] h-[383px] shadow-metrics bg-white flex flex-col pt-[61px] pl-[34px] pr-[34px] cursor-pointer hover:bg-gray-200 transition"
      ...
      {/* Modal (visible only when showModal is true) */}
      {showModal && <AddBranchModal onClose={() => setShowModal(false)} />}
    </div>
  );
};
