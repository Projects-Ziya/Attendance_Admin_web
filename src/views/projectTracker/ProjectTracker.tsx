...
const ProjectListView = () => {
  ...
  return (
    <div className="p-6 bg-[#F6F5FA] min-h-screen">
      ...
      {/* Headers */}
      {activeButton === "projects" ? (
        <div className="grid grid-cols-[170px_1.2fr_0.8fr_0.7fr_0.8fr_240px] bg-[#F4F4F4] font-semibold text-ziyablack px-7 py-4">
          <div>Proj / Date</div>
        ...
        <div className="grid grid-cols-[170px_1.2fr_0.9fr_0.9fr_0.8fr_100px] bg-[#F4F4F4] font-semibold text-ziyablack px-7 py-4">
          <div>Tasks / Date</div>
          <div>Coordinators</div>
          <div>Assignee</div>
          <div>End Date</div>
