...
const DeductionDetailsCards: React.FC = () => {
 ...
 const handleDelete = async (id: number) => {
  ...
  return (
    <div
  className="grid grid-cols-1 md:grid-cols-2 gap-[40px] justify-center pb-[40px] w-full mx-auto"
>
  {deductions.map((deduction) => {
    ...
    return (
      <div
        key={deduction.id}
        className="w-full md:max-w-[700px] h-auto border rounded-[10px] shadow-sm flex flex-col"
      ...
      >
        ...
        <div className="pt-[40px] px-[27px]">
          ...
          <div
            className="w-full md:max-w-[655px] h-auto min-h-[90px] pl-[29px] pt-[10px] rounded-[20px] mt-[20px]"
            style={{
