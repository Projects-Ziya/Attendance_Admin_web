...
type Props = {
  onClose: () => void;
  onUploaded: () => void; // ✅ NEW: notify parent after upload
};

const UploadNewWorksheet: React.FC<Props> = ({ onClose, onUploaded }) => {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      onUploaded(); // ✅ IMPORTANT: refresh worksheet list
      onClose();    // ✅ close modal
    } catch (error) {
