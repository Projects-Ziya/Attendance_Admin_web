    ...
    <div className="border-b border-gray-200 -mx-4">
      <div className="grid grid-cols-[170px_1.3fr_1.0fr_1.0fr_160px_120px] items-center pl-11 py-4 px-7 text-sm">
        ...
        <Link to="/singleProjectTracker">
          <div>
            <p className="font-medium text-ziyablack">{project.project_name}</p>
            <span className="text-gray-500 text-xs">{project.start_date?.split(" ")[0]}</span>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="font-semibold truncate">{project.coordinator?.name}</p>
        ...
        <div className="flex items-center">
          ...
          <span className="text-gray-800 text-sm truncate">{project.assignee_name || "N/A"}</span>
        </div>
        </div>
        

        {/* Deadline */}
        <p className="text-gray-800 text-sm">{project.end_date || "N/A"}</p>
