...
function Worksheet() {
  ...
  <div
    className={`min-h-screen w-full mx-auto 
                sm:max-w-full md:max-w-[90%] xl:max-w-[1469px] mb-[30px] p-6 bg-[#F6F5FA] transition-filter duration-300 ${
  ...
  >
    ...
    {/* Main card */}
    <div className="h-auto w-full bg-[#FCFCFC] pb-[40px] border rounded-[10px] shadow-sm px-7">
      {/* Header */}
      ...
      {/* Upload button */}
      <div className="flex justify-end mb-[40px] px-7">
        <motion.button
      ...
      {/* Team Worksheets */}
      <div className="h-[700px] w-full shadow-sm border border-[#DED1D1] rounded-[20px] pb-8 px-7">
        <h1 className="font-[600] text-[24px] pt-[49px]">Team Worksheets</h1>
        ...
        <div className="mt-[70px] space-y-[40px]">
          ...
          <AnimatePresence>
            {worksheets.map((w) => (
              <motion.div
                key={w.id}
                className="h-[108px] w-full rounded-[20px] border border-[#C6C6C6] bg-white flex items-center justify-between px-6"
                ...
                <div className="flex items-center gap-[16px]">
                  <div className="h-[60px] w-[61px] rounded-[16px] bg-[#C0EDBF] flex items-center justify-center">
                    <img
                      src={doc_icon}
                      alt="Document"
                      className="h-[33.833px] w-[29px]"
                    />
                  </div>
                  <div>
                    <p className="text-[22px] font-[500] text-[#000000]">
                      {w.title}
                    </p>
                ...
                <div className="flex items-center gap-[16px]">
                  <motion.button
                    ...
                    className="flex items-center justify-center gap-3 h-[50px] w-[173px] px-[20px] rounded-lg
                               bg-gradient-to-r font-medium text-[16px]
