...
setEndTime(shift.end_time.slice(0, 5));
  ...
  return (
<div
  className="w-full mx-auto sm:max-w-full md:max-w-[90%] xl:max-w-[1469px] 
             h-auto mt-5 flex flex-col md:flex-row gap-[10px] opacity-100"
>
  {/* Left Panel: Add/Edit Shift */}
  <div
    className="w-full md:w-1/2 rounded-lg bg-white shadow-[0px_0px_2px_0px_#00000040] 
               flex flex-col gap-6 px-6 md:pl-[40px] md:pr-[28px] pb-[40px]"
  >
    <h2 className="text-[#4D4D4D] text-[22px] font-[600] mt-[49px]">
  ...
  {/* Right Panel: Scheduled Shifts */}
  <div
    className="w-full md:w-1/2 h-[650px] overflow-y-auto rounded-lg bg-white 
               shadow-[0px_0px_2px_0px_#00000040] px-6 md:px-[39px]"
  >
    <h1 className="text-[#4D4D4D] text-[22px] font-[600] mt-[49px]">
      Scheduled Shifts
    </h1>
    ...
    {shifts.length === 0 ? (
      <div className="text-center flex flex-col items-center justify-center mb-2 font-[600] text-[#C3C3C3] text-[22px]">
        <img
          src={calender}
          className="w-[97px] h-[97px] mt-[112px] mb-[34px]"
        />
      ...
      <div className="flex flex-col gap-4 mt-[40px]">
        {shifts.map((s) => (
          <div
            key={s.id}
            className="w-full md:max-w-[629px] h-auto border border-gray-300 
                       rounded-[5px] px-6 py-4 shadow-sm bg-white flex flex-col 
